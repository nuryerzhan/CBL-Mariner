...
Patch4: tests-makefile-fix.patch
Patch5: tests-run_tests-fix-hugeadm-path.patch
...
Patch6: huge_page_setup_helper-python3-convert.patch
# Fixes for downstream COVSCAN and RPMDiff execshield complaints:
Patch7: tests-fix-covscan-SHELLCHECK_WARNING-complaints.patch
Patch8: tests-include-missing-LDFLAGS-to-make-targets.patch
...
execstack --clear-execstack %{buildroot}/%{_lib64dir}/libhugetlbfs.so
execstack --clear-execstack %{buildroot}/%{_lib64dir}/libhugetlbfs_privutils.so

# remove statically built libraries:
rm -f $RPM_BUILD_ROOT/%{_lib64dir}/*.a
rm -f $RPM_BUILD_ROOT/%{_lib64dir}/libhugetlbfs/tests/*/*.link*
...
%files
%{_lib64dir}/libhugetlbfs.so*
%{_lib64dir}/libhugetlbfs_privutils.so*
%{_datadir}/%{name}/
...
%exclude %{_lib64dir}/perl5/TLBC

%files tests
%{_lib64dir}/libhugetlbfs
